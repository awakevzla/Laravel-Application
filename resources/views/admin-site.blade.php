...
<head>
    ...
    <!-- iCheck -->
    <link href="{{ asset("bower_components/admin-lte/plugins/iCheck/flat/blue.css") }}" rel="stylesheet" type="text/css" />
    <!-- Morris chart -->
...
<script src="{{ asset("bower_components/admin-lte/dist/js/pages/dashboard.js") }}" type="text/javascript"></script>
